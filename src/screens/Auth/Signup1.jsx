  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <Text style={styles.TextH3}>User ID</Text>
        ...
        <Text
          ...
          Make sure you Screenshot your ID or write it down.{'\n\n'}
          You need it to Login{'\n\n'}
          Please Enter your Email where we can send your User ID in case you
          forget it.{'\n\n'}
        ...
        <View>
          <FloatingLabelInput
            ...
            containerStyles={{
              ...styles.floatingcontainerstyle,
              borderBottomColor:
                inviteCode !== '' ? Colors.mainColor : Colors.darkgrey,
            }}
          />
        </View>
        <Spacer height={50} />
