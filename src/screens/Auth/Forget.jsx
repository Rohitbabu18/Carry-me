        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.modalBox}>
                    <View style={stylesCustom.Icon}>
                        <MaterialCommunityIcons size={35} color={Colors.mainColor} style={{}} name="email-send" />
                    </View>
                    <Spacer height={10} />
                    <Text style={{ ...styles.headingText, textAlign: 'center', paddingLeft: horizScale(0), }}>Email Sent</Text>
            ...
            </View>
            {
                forgetOption == 1 ?
                    <View>
                        <Spacer height={50} />
                        <Text style={styles.smallText}>Please enter your email address, We will sent your USERNAME on your email.</Text>
                        <Spacer height={15} />
                        <FloatingLabelInput
                            label={'Email'}
                            value={email}
